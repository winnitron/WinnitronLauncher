...
Shader "VacuumShaders/The Amazing Wireframe/Unlit/Transparent/Texture"
{
    Properties 
    {
		//Tag
    ...
    SubShader  
    {
		Tags {"Queue"="Transparent+10" "IgnoreProjector"="True" "RenderType"="Transparent" "WireframeTag"="Unlit/Transparent/Texture"}
