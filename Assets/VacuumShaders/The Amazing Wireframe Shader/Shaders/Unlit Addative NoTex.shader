...
Shader "VacuumShaders/The Amazing Wireframe/Unlit/Addative/NoTex"
{
    Properties 
    {
		//Tag
    ...
    SubShader  
    {
		Tags {"Queue"="Transparent" "IgnoreProjector"="True" "RenderType"="Transparent" "WireframeTag"="Unlit/Addative/NoTex"}
