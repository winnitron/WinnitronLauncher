...
Shader "VacuumShaders/The Amazing Wireframe/Deferred/Transparent/Diffuse 2Sided" 
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags {"Queue"="Transparent+10" "IgnoreProjector"="True" "RenderType"="Transparent" "WireframeTag"="Deferred/Transparent/Diffuse 2 Sided"}
		LOD 200 
