...
Shader "VacuumShaders/The Amazing Wireframe/Unlit/Multiply/Texture"
{
    Properties 
    {
		//Tag
    ...
    SubShader  
    {
		Tags {"Queue"="Transparent" "IgnoreProjector"="True" "RenderType"="Transparent" "WireframeTag"="Unlit/Multiply/Texture"}
