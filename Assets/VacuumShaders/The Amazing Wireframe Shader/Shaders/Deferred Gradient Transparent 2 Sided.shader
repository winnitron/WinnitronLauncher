...
Shader "VacuumShaders/The Amazing Wireframe/Deferred/Gradient/Transparent 2 Sided" 
{
	Properties 
	{		
		//Tag
	...
	SubShader 
	{ 
		Tags {"Queue"="Transparent+10" "IgnoreProjector"="True" "RenderType"="Transparent" "WireframeTag"="Deferred/Gradient/Transparent 2 Sided"}
		LOD 200 
