...
Shader "VacuumShaders/The Amazing Wireframe/Deferred/Gradient/Opaque" 
{
	Properties 
	{		
		//Tag
		...
		V_WIRE_GradientColor("Gradient Color (RGB)", color) = (1, 1, 1, 1)		
	}
	 
	SubShader 
	{ 
		Tags { "RenderType"="Opaque" "WireframeTag"="Deferred/Gradient/Opaque"}
		LOD 200
