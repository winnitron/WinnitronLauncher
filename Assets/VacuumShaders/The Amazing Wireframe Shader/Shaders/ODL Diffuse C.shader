...
Shader "VacuumShaders/The Amazing Wireframe/One Directional Light/Cutout/Diffuse"
{
    Properties 
    {
		//Tag
    ...
    SubShader   
    {
		Tags {"Queue"="AlphaTest" "IgnoreProjector"="True" "RenderType"="TransparentCutout" "WireframeTag"="One Directional Light/Cutout/Diffuse"}
