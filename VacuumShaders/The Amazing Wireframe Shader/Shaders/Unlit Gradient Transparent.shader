...
Shader "VacuumShaders/The Amazing Wireframe/Unlit/Gradient/Transparent"
{ 
    Properties 
    {
		//Tag
    ...
    SubShader 
    {
		Tags {"Queue"="Transparent+10" "IgnoreProjector"="True" "RenderType"="Transparent" "WireframeTag"="Unlit/Gradient/Transparent"}
