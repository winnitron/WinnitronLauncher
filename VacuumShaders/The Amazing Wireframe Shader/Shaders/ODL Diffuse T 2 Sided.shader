...
Shader "VacuumShaders/The Amazing Wireframe/One Directional Light/Transparent/Diffuse 2 Sided"
{
    Properties 
    {
		//Tag
    ...
    SubShader   
    {
		Tags {"Queue"="Transparent+10" "IgnoreProjector"="True" "RenderType"="Transparent" "WireframeTag"="One Directional Light/Transparent/Diffuse 2 Sided"}
