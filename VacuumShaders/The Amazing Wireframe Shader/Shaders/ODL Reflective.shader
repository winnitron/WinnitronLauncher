...
Shader "VacuumShaders/The Amazing Wireframe/One Directional Light/Reflective"
{
    Properties 
    {
		//Tag
    ...
    SubShader   
    {
		Tags { "Queue"="Geometry" "RenderType"="Opaque" "WireframeTag"="One Directional Light/Reflective"}
