...
Shader "VacuumShaders/The Amazing Wireframe/One Directional Light/Transparent/Diffuse"
{
    Properties 
    {
		//Tag
    ...
    SubShader   
    {
		Tags {"Queue"="Transparent+10" "IgnoreProjector"="True" "RenderType"="Transparent" "WireframeTag"="One Directional Light/Transparent/Diffuse"}
